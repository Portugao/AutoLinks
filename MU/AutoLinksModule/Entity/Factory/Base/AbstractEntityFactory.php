...
use MU\AutoLinksModule\Entity\Factory\EntityInitialiser;
...
abstract class AbstractEntityFactory
{
    ...
    {
        $entityClass = 'MU\\AutoLinksModule\\Entity\\' . ucfirst($objectType) . 'Entity';
    ...
    /**
     * Creates a new autoLink instance.
     *
     * @return MU\AutoLinksModule\Entity\autoLinkEntity The newly created entity instance
     */
    public function createAutoLink()
    {
        $entityClass = 'MU\\AutoLinksModule\\Entity\\AutoLinkEntity';

        $entity = new $entityClass();

        $this->entityInitialiser->initAutoLink($entity);
    ...
    public function getIdField($objectType = '')
    {
        ...
        $entityClass = 'MUAutoLinksModule:' . ucfirst($objectType) . 'Entity';
