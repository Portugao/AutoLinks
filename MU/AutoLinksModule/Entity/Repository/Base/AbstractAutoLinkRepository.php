...
namespace MU\AutoLinksModule\Entity\Repository\Base;
...
use MU\AutoLinksModule\Helper\CollectionFilterHelper;

/**
 * Repository class used to implement own convenience methods for performing certain DQL queries.
 *
 * This is the base repository class for auto link entities.
 */
abstract class AbstractAutoLinkRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'MU\AutoLinksModule\Entity\AutoLinkEntity';

    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'supportedString';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'MUAutoLinksModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'auto links', 'userid' => $userId];
     ...
     *
     * @return array|autoLinkEntity Retrieved data array or autoLinkEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved autoLinkEntity instances
     */
    public function selectByIdList($idList = [0], $useJoins = true, $slimMode = false)
    {
        ...
        if (!$slimMode && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('autoLink', $qb);
        }
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if (!$slimMode && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('autoLink', $qb);
        }
    ...
    public function selectSearch($fragment = '', array $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('autoLink', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numAutoLinks';
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('autoLink', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of auto links to exclude (optional)
     *
     * @return boolean Result of this check, true if the given auto link does not already exist
     */
