...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from auto links app';
     *     $event->getRequest()->attributes->set('MUAutoLinksModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('MUAutoLinksModule_test');`
     *     now `$testMessage` should be: `'Hello from auto links app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('auto links App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
