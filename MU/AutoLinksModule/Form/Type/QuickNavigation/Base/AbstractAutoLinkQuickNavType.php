...
namespace MU\AutoLinksModule\Form\Type\QuickNavigation\Base;
...
/**
 * Auto link quick navigation form type base class.
 */
abstract class AbstractAutoLinkQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * AutoLinkQuickNavType constructor.
     *
    ...
    {
        $listEntries = $this->listHelper->getEntries('autoLink', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'muautolinksmodule_autolinkquicknav';
    }
}
